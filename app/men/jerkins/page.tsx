...
const MenJerkinsPage = (props: Props) => {
  const categories = [
    {
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        <main className="relative pt-[120px] sm:pt-[140px] px-4 sm:px-8 lg:px-32">
          ...
          <div className="mb-6">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator>/</BreadcrumbSeparator>
                <BreadcrumbItem>
                  <BreadcrumbLink href="/men/jerkins">Jerkins</BreadcrumbLink>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-baseline sm:space-x-2 mb-8">
            <h1 className="font-extrabold text-3xl sm:text-4xl">MEN JERKINS</h1>
