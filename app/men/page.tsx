  ...
  const categories = [
    {
      ...
      link: "https://www.adidas.co.in/men-shoes",
    },
    {
      name: "apparel",
      imageLink:
    ...
    },
    {
      ...
      link: "https://www.adidas.co.in/men-accessories",
    },
  ];
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        <main className="relative pt-[88px] sm:pt-[104px] px-4 sm:px-8 lg:px-32">
          ...
          <div className="flex flex-col sm:flex-row sm:items-baseline sm:space-x-2 mb-4">
            <h1 className="font-extrabold text-3xl sm:text-4xl">MEN</h1>
            <span className="text-gray-500 text-sm sm:text-xs mt-1 sm:mt-0">
              [200]
            </span>
          </div>
