...
const WomenFormalsPage = (props: Props) => {
  const categories = [
    {
      name: "blazers",
      imageLink:
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        <main className="relative pt-[120px] sm:pt-[140px] px-4 sm:px-8 lg:px-32">
          ...
          <div className="mb-6">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator>/</BreadcrumbSeparator>
                <BreadcrumbItem>
                  <BreadcrumbLink href="/women/formals">Formals</BreadcrumbLink>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-baseline sm:space-x-2 mb-8">
            <h1 className="font-extrabold text-3xl sm:text-4xl">WOMEN FORMALS</h1>
            <span className="text-gray-500 text-sm sm:text-xs mt-1 sm:mt-0">[67]</span>
          </div>
...
export default WomenFormalsPage
